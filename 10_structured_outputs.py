...
# - Function Calling: Demonstrated in previous examples.
# - JSON Schema Response Format: Specify a `response_format` to directly control the structure of the model's output
#
...
#            to the model using the `response_format` parameter. 
